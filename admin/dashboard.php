...
<body>
    ...
    <main class="relative h-screen overflow-hidden bg-white-100 dark:bg-white-800 rounded-2xl">
                ...
                <div class="h-full bg-white rounded-2xl dark:bg-gray-700">
                    ...
                    <nav class="mt-6">
                        <div>
                            ...
                            <a class="flex items-center justify-start w-full p-4 my-2 font-thin text-blue-500 uppercase transition-colors duration-200 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800" href="?path=add-quote">
                                <span class="text-left">
                            ...
                            <a  class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500" href="logout-handle.php">
                                <span class="text-left">
                                    <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.267 4.209a.75.75 0 0 0-1.034 1.086l6.251 5.955H3.75a.75.75 0 0 0 0 1.5h14.734l-6.251 5.954a.75.75 0 0 0 1.034 1.087l7.42-7.067a.996.996 0 0 0 .3-.58.758.758 0 0 0-.001-.29.995.995 0 0 0-.3-.578l-7.419-7.067Z" ></svg>
